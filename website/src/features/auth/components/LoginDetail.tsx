    ...
    const onSubmit = async (values: LoginFormValues) => {
        ...
        try {
            ...
            if (error.message.includes('invalid-credential')) {
                toast.error('Could not find an account with this email and password')
                return
            }
        ...
        <div className="flex flex-col items-center justify-center p-6 py-20 bg-linear-to-b from-white to-(--color-bg-subtle)">
            <div className="w-full max-w-md flex flex-col gap-10">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex justify-between items-center ml-1">
                                <label className="text-[13px] font-bold text-(--color-text-secondary)">Password</label>
                            </div>
                            <div className="relative group">
                ...
                <p className="text-center text-[14px] text-(--color-text-secondary) font-medium">
                    Don't have an account? <Link to="/signup" className="text-(--color-accent) font-bold hover:underline">Get started</Link>
                </p>
            </div>
        </div>
    )
