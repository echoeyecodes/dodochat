...
import { deleteCookie, getCookies, getRequestHeaders, setCookie } from "@tanstack/react-start/server";
import { z } from "zod";

export const ACCESS_TOKEN_KEY = "access_token"
export const REFRESH_TOKEN_KEY = "refresh_token"

export const updateAuthSession = createServerFn({ method: "POST" }).inputValidator(z.object({
