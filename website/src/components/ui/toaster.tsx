...
const Toaster = ({ ...props }: ToasterProps) => {
    return (
        <Sonner
            ...
            toastOptions={{
                classNames: {
                    toast: "group toast group-[.toaster]:bg-(--color-bg-elevated) group-[.toaster]:text-(--color-text-primary) group-[.toaster]:border-(--color-border) group-[.toaster]:shadow-(--shadow-editorial) group-[.toaster]:rounded-xl font-body p-4 gap-3",
