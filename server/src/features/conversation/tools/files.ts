...
export const fileTools = {
    generateFile: tool({
        description: 'Generate a text (.txt) or PDF (.pdf) file from provided content and save it to the chat storage.',
        inputSchema: z.object({
            ...
            filename: z.string().describe('The name of the file (e.g. "report", "summary"). Extension will be added automatically.'),
            conversationId: z.string().describe('The current conversation ID to associate the file with.')
        }),
