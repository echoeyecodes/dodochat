...
router.get(
    ...
    conversationActions.searchConversations,
);
router.get(
    "/public/:token",
    validate(GetSharedConversationSchema),
    conversationActions.getSharedConversation,
);
router.post(
    "/public/:token/fork",
    isAuthenticated,
    validate(ForkConversationSchema),
    conversationActions.forkConversation,
);
router.get(
    "/:id",
    isAuthenticated,
    validate(GetConversationSchema),
    conversationActions.getConversation,
);
router.get(
    "/:id/files",
    isAuthenticated,
    validate(GetConversationSchema),
    conversationActions.getConversationFiles,
);
...
router.post(
    "/:id/share",
    isAuthenticated,
    validate(ShareConversationSchema),
    conversationActions.shareConversation,
);
