...
import { GetConversationSchema, DeleteConversationSchema, ChatSchema, SearchConversationsSchema, UpdateConversationSchema, ShareConversationSchema, GetSharedConversationSchema, ForkConversationSchema } from './req-schema';
...
router.get('/public/:token', validate(GetSharedConversationSchema), conversationActions.getSharedConversation);
router.post('/public/:token/fork', isAuthenticated, validate(ForkConversationSchema), conversationActions.forkConversation);
...
router.post('/:id/share', isAuthenticated, validate(ShareConversationSchema), conversationActions.shareConversation);
